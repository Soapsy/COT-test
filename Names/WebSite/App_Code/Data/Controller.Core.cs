    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (string.IsNullOrEmpty(survey))
                survey = ControllerConfigurationUtility.GetResourceText(string.Format("TestCompany.Surveys.{0}.min.js", surveyName), string.Format("TestCompany.{0}.min.js", surveyName), string.Format("TestCompany.Surveys.{0}.js", surveyName), string.Format("TestCompany.{0}.js", surveyName));
            if (string.IsNullOrEmpty(survey))
                throw new HttpException(404, "Not found.");
            if (string.IsNullOrEmpty(layout))
                layout = ControllerConfigurationUtility.GetResourceText(string.Format("TestCompany.Surveys.{0}.html", surveyName), string.Format("TestCompany.Surveys.{0}.htm", surveyName), string.Format("TestCompany.{0}.html", surveyName), string.Format("TestCompany.{0}.htm", surveyName));
            if (string.IsNullOrEmpty(rules))
                rules = ControllerConfigurationUtility.GetResourceText(string.Format("TestCompany.Surveys.{0}.rules.min.js", surveyName), string.Format("TestCompany.{0}.rules.min.js", surveyName), string.Format("TestCompany.Surveys.{0}.rules.js", surveyName), string.Format("TestCompany.{0}.rules.js", surveyName));
