...
namespace TestCompany.Handlers
{
    ...
    public class SiteBase : TestCompany.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2023 TestCompany. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            var themePath = Server.MapPath("~/App_Themes/TestCompany");
            if (Directory.Exists(themePath))
                foreach (var stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!fileName.Equals("_Theme_Aquarium.css"))
                    {
                        ...
                        {
                            Href = ("~/App_Themes/TestCompany/" + fileName)
                        };
