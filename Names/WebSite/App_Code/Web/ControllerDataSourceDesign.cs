...
namespace TestCompany.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("TestCompany.Controllers.{0}.xml", DataController));
                if (res == null)
                    res = GetType().Assembly.GetManifestResourceStream(string.Format("TestCompany.{0}.xml", DataController));
                if (res != null)
